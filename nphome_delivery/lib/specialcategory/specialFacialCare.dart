...
class SpecialFacialCare extends StatefulWidget {
  @override
  _SpecialFacialCareState createState() => _SpecialFacialCareState();
}

class _SpecialFacialCareState extends State<SpecialFacialCare> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Facial Care',style: TextStyle(letterSpacing: 2),),
        ...
        builder:  (context, snapshot) {
          if(!snapshot.hasData){
            ...
            for (int i = 0; i < snapshot.data.documents.length; i++){
              ...
              if (dbCatagory.contains('Facial Care')) {
