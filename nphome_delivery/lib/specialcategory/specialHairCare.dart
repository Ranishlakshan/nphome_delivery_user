...
class SpecialHairCare extends StatefulWidget {
  @override
  _SpecialHairCareState createState() => _SpecialHairCareState();
}

class _SpecialHairCareState extends State<SpecialHairCare> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Hair Care',style: TextStyle(letterSpacing: 2),),
        ...
        builder:  (context, snapshot) {
          if(!snapshot.hasData){
            ...
            for (int i = 0; i < snapshot.data.documents.length; i++){
              ...
              if (dbCatagory.contains('Hair Care')) {
